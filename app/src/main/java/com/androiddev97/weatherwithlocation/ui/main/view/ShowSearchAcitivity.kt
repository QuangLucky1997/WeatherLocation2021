...
class ShowSearchAcitivity : AppCompatActivity() {
    private lateinit var weatherViewModel: DataWeatherViewModel
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.fragment_weather)
        val intentGetData = intent
        val rsCityName=intentGetData.getStringExtra(App.SEND_RS)
        if (rsCityName != null) {
            setUpViewModel()
            setUpObserver(rsCityName)
        }
    }
    ...
    private fun setDataWeather(weatherData: ForecastWeatherResponse) {
        ...
        val dayFirst: String = java.lang.String.valueOf(weatherData.list[0].dt)
        ...
        val dayNext1: String = java.lang.String.valueOf(weatherData.list[6].dt)
        ...
        val dayNext2: String = java.lang.String.valueOf(weatherData.list[14].dt)
        ...
        val dayNext3: String = java.lang.String.valueOf(weatherData.list[22].dt)
        ...
        val dayNext4: String = java.lang.String.valueOf(weatherData.list[30].dt)
        ...
        val dayNext5: String = java.lang.String.valueOf(weatherData.list[38].dt)
